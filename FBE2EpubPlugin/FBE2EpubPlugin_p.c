...
typedef struct _FBE2EpubPlugin_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } FBE2EpubPlugin_MIDL_TYPE_FORMAT_STRING;

typedef struct _FBE2EpubPlugin_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } FBE2EpubPlugin_MIDL_PROC_FORMAT_STRING;

typedef struct _FBE2EpubPlugin_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } FBE2EpubPlugin_MIDL_EXPR_FORMAT_STRING;
...
extern const FBE2EpubPlugin_MIDL_TYPE_FORMAT_STRING FBE2EpubPlugin__MIDL_TypeFormatString;
extern const FBE2EpubPlugin_MIDL_PROC_FORMAT_STRING FBE2EpubPlugin__MIDL_ProcFormatString;
extern const FBE2EpubPlugin_MIDL_EXPR_FORMAT_STRING FBE2EpubPlugin__MIDL_ExprFormatString;
...
extern const MIDL_SERVER_INFO IFBEExportPlugin_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IFBEExportPlugin_ProxyInfo;


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO IFbePluginImplementation_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IFbePluginImplementation_ProxyInfo;
...
static const FBE2EpubPlugin_MIDL_PROC_FORMAT_STRING FBE2EpubPlugin__MIDL_ProcFormatString =
    {
        0,
        {
...
static const FBE2EpubPlugin_MIDL_TYPE_FORMAT_STRING FBE2EpubPlugin__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO IComponentRegistrar_ProxyInfo =
    {
    &Object_StubDesc,
    FBE2EpubPlugin__MIDL_ProcFormatString.Format,
...
/* Object interface: IFBEExportPlugin, ver. 0.0,
   GUID={0x1afaab7f,0x6f66,0x4ef6,{0xb1,0x99,0x16,0xfa,0x49,0xcc,0x5b,0x52}} */

#pragma code_seg(".orpc")
static const unsigned short IFBEExportPlugin_FormatStringOffsetTable[] =
    {
    210
    };

static const MIDL_STUBLESS_PROXY_INFO IFBEExportPlugin_ProxyInfo =
    {
    &Object_StubDesc,
    FBE2EpubPlugin__MIDL_ProcFormatString.Format,
    &IFBEExportPlugin_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IFBEExportPlugin_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    FBE2EpubPlugin__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(4) _IFBEExportPluginProxyVtbl = 
{
    &IFBEExportPlugin_ProxyInfo,
    &IID_IFBEExportPlugin,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    (void *) (INT_PTR) -1 /* IFBEExportPlugin::Export */
};

const CInterfaceStubVtbl _IFBEExportPluginStubVtbl =
{
    &IID_IFBEExportPlugin,
    &IFBEExportPlugin_ServerInfo,
    4,
    0, /* pure interpreted */
...
/* Object interface: IFbePluginImplementation, ver. 0.0,
   GUID={0xB09520C4,0xD1E8,0x4491,{0xAE,0xDC,0x49,0xB7,0xD9,0xAE,0x61,0xA0}} */

#pragma code_seg(".orpc")
static const unsigned short IFbePluginImplementation_FormatStringOffsetTable[] =
    {
    0
    };

static const MIDL_STUBLESS_PROXY_INFO IFbePluginImplementation_ProxyInfo =
    {
    &Object_StubDesc,
    FBE2EpubPlugin__MIDL_ProcFormatString.Format,
    &IFbePluginImplementation_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IFbePluginImplementation_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    FBE2EpubPlugin__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(3) _IFbePluginImplementationProxyVtbl = 
{
    0,
    &IID_IFbePluginImplementation,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy
};

const CInterfaceStubVtbl _IFbePluginImplementationStubVtbl =
{
    &IID_IFbePluginImplementation,
    &IFbePluginImplementation_ServerInfo,
    3,
    0, /* pure interpreted */
    CStdStubBuffer_METHODS
};
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    FBE2EpubPlugin__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _FBE2EpubPlugin_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IFBEExportPluginProxyVtbl,
    ( CInterfaceProxyVtbl *) &_IComponentRegistrarProxyVtbl,
    ( CInterfaceProxyVtbl *) &_IFbePluginImplementationProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _FBE2EpubPlugin_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IFBEExportPluginStubVtbl,
    ( CInterfaceStubVtbl *) &_IComponentRegistrarStubVtbl,
    ( CInterfaceStubVtbl *) &_IFbePluginImplementationStubVtbl,
    0
};

PCInterfaceName const _FBE2EpubPlugin_InterfaceNamesList[] = 
{
    "IFBEExportPlugin",
    "IComponentRegistrar",
    "IFbePluginImplementation",
    0
};

const IID *  const _FBE2EpubPlugin_BaseIIDList[] = 
{
    0,
    &IID_IDispatch,
    0,
...
#define _FBE2EpubPlugin_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _FBE2EpubPlugin, pIID, n)

int __stdcall _FBE2EpubPlugin_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _FBE2EpubPlugin, 3, 2 )
    IID_BS_LOOKUP_NEXT_TEST( _FBE2EpubPlugin, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _FBE2EpubPlugin, 3, *pIndex )
    
}

const ExtendedProxyFileInfo FBE2EpubPlugin_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _FBE2EpubPlugin_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _FBE2EpubPlugin_StubVtblList,
    (const PCInterfaceName * ) & _FBE2EpubPlugin_InterfaceNamesList,
    (const IID ** ) & _FBE2EpubPlugin_BaseIIDList,
    & _FBE2EpubPlugin_IID_Lookup, 
    3,
    2,
