...
/**
* DownloadSaver override to allow deserialization of fb2epub saver
*/
this.DownloadSaverEx = function () {}
 ...
 */
this.DownloadSaverEx.fromSerializable = function (aSerializable) {
