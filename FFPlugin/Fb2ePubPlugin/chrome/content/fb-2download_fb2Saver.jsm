...
// {
 // if(!(this instanceof Fb2DownloadCopySaverToEPub)){
    // return new Fb2DownloadCopySaverToEPub();
  // }
  // return this;
// }
...
// this.Fb2DownloadCopySaverToEPub.prototype = {
    ...
    // return Task.spawn(function task_DCS_execute() {
      ...
      // try {
          ...
          // channel.asyncOpen({
            // onStartRequest: function (aRequest, aContext) {
              ...
              // if (aRequest instanceof Ci.nsIHttpChannel &&
                ...
                // // cancellation so that the proper error can be thrown.
                // this.download._blockedByParentalControls = true;
                // aRequest.cancel(Components.resultsNS_BINDING_ABORTED);
                // return;
              // }
              ...
              // if (keepPartialData) {
                ...
                // if (aRequest instanceof Ci.nsIResumableChannel) {
                  ...
                  // } catch (ex if ex instanceof Components.Exception &&
                                 // ex.result == Components.resultsNS_ERROR_NOT_RESUMABLE) {
              ...
              // if (partFilePath) {
                // // If we actually resumed a request, append to the partial data.
                // if (resumeAttempted) {
                  // // TODO: Handle Components.resultsNS_ERROR_ENTITY_CHANGED
                  // backgroundFileSaver.enableAppend();
                // }
                ...
                // if (Components.isSuccessCode(aStatusCode)) {
                  // if (partFilePath) {
                    ...
                    // backgroundFileSaver.setTarget(
                                        // new FileUtils.File(targetPath), false);
                  // }
                  // backgroundFileSaver.finish(Components.resultsNS_OK);
                // }
              // }
            // }.bind(copySaver),
        ...
        // } catch (ex) {
          // // In case an error occurs while setting up the chain of objects for
          // // the download, ensure that we release the resources of the saver.
          // backgroundFileSaver.finish(Components.resultsNS_ERROR_FAILURE);
          // throw ex;
        // }
  ...
  // {
    ...
    // if (this._backgroundFileSaver) {
      // this._backgroundFileSaver.finish(Components.resultsNS_ERROR_FAILURE);
      // this._backgroundFileSaver = null;
    // }
  // },
